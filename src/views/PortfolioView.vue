      ...
      items: [
        {
          ...
          imageUrl: 'portal',
            status: 'This portal is designed to help users record all activities carried out in the agency such as promotions, trainings and others.',
        ...
        }, 
        {
          ...
          imageUrl: 'iaf',
          status: 'A custom portfolio website for the International Army Force, built to showcase activities, ranks, and resources for the Habbo agency roleplay community.',
