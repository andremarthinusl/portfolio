<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">      <p class="text-blue-400">Hello World, I'm</p>
      <h1 class="text-2xl font-bold md:text-3xl lg:text-5xl text-white fadein-up">Andre Marthinus Lumempouw</h1>
      <div class="py-1 md:py-2">
        <h1 class="typewrite text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-blue-500 md:text-2xl fadein-up"
          ref="typewriter">
    ...
    </div>    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-blue-400 pict" src="https://avatars.githubusercontent.com/u/192032451?v=4">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Informatics Student"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
